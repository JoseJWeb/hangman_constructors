...
var hangman = {
    ...
    display: 0,
    currentWord: null, // starts at nada null, not undefined
    //asks user if they are ready to play
    startGame: function() {
        var that = this;
        //clears guessedLetters before a new game begins if it's not already empty.
        ...
        inquirer.prompt([{
            ...
            if (answer.play) {
                ...
                console.log("Fine, We can play some other time when you are not coding..");
            }
        })
    },
            ...
            if (guessedAlready === false) {
                ...
                if (found === 0) {
                    ...
                    if (that.currentWord.didWeFindTheWord() === true) {
                        console.log(that.currentWord.wordRender());
                        console.log('Congratulations! You are a Hero!!!');
                        // that.startGame();
                    } else {
